    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            try
            {
                ...
                faceClient = new FaceClient(credentials) { Endpoint = cogSvcEndpoint };
                ...
                {
                    case "1":
                        await DetectFaces("images/emad.jpg");
                        break;
                    default:
                        break;
                }
        ...
        static async Task DetectFaces(string imageFile)
        {
            ...
            {
                var detected_faces = await faceClient.Face.DetectWithStreamAsync(
                    imageData,
